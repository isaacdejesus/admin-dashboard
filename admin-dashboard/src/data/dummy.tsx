...
import {BarPrimaryXAxis, BarPrimaryYAxis, BarCustomSeries} from '../types';
import { RangeColorMapping, ColorMappingPrimaryXAxisProps, ColorMappingPrimaryYAxisProps} from '../types'
import {FinancialPrimaryXAxisProps, FinancialPrimaryYAxisProps, CartData, ChatData} from '../types';
import { RecentTransactions, WeeklyStats, ProductsPerformance, MedicalProBranding} from '../types';
import {UserProfileData, DropDownData, PieChartData} from '../types';
import { FinancialChartData, PyramidDataProps} from '../types';
...
export const barPrimaryYAxis: BarPrimaryYAxis= {
  majorGridLines: { width: 0 },
  majorTickLines: { width: 0 },
  lineStyle: { width: 0 },
...
export const barCustomSeries: BarCustomSeries[]= [
  {
...
export const ColorMappingPrimaryYAxis: ColorMappingPrimaryYAxisProps = {
  lineStyle: { width: 0 },
  majorTickLines: { width: 0 },
  minorTickLines: { width: 0 },
  labelFormat: '{value}°C',
...
export const FinancialPrimaryYAxis: FinancialPrimaryYAxisProps= {
  title: 'Price',
  minimum: 100,
  maximum: 180,
  interval: 20,
...
export const productsPerformance: ProductsPerformance[]= [
  {
    image:
      product5,
...
export const medicalproBranding: MedicalProBranding= {
  data: [
    {
      title: 'Due Date',
      desc: 'Oct 23, 2021',
...
export const PyramidData: PyramidDataProps[]= [
